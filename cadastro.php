...
<fieldset>
  ...
  <div class="form-group">
    ...
    <div class="valid-feedback">Válido.</div>
    <div class="invalid-feedback">Coloque uma senha forte.</div>
  </div>
  <div class="form-group">
    <label for="senha2">Repita a senha:</label>
    <input type="password" class="form-control" id="senha2" placeholder="Digite novamente a senha" name="senha2" required>
    <div class="valid-feedback">Válido.</div>
    <div class="invalid-feedback">A senha deve ser idêntica a digitada no campo acima.</div>
  </div>
  <div class="form-group">
 ...
 termos de condição</button></span>.
      <div class="valid-feedback">Válido.</div>
      <div class="invalid-feedback">Marque esta caixa e a <b>*LEIA*</b> para continuar.</div>
    </label>
  </div>
...
?>
  ...
  <!-- <b><i><p>The Janaúba Times</i></b><sup>&copy;</sup> 2019. Todos os direitos reservados</p> -->
</div>
